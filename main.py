...
def process_titles_with_gpt(titles_text):
    prompt_text = (
            "Обобщите заголовки следующих новостей, представив их в виде бюллетеня. Используйте тег <b> для выделения "
            "заголовка бюллетеня 'Бюллетень новостей:' и номеров пунктов. Для каждого заголовка новости используйте "
            ...
            "перенос строки <br> для разделения разных новостей. Вот пары заголовков и ссылок: " + titles_text
    )
